...
public class ChessMatch {
	...
	public void performChessMove(ChessPosition sourceposition, ChessPosition targetposition) {
		...
		// If the chosen movement put the current player in check, then undo move.
	...
	private boolean testCheck(Color color) {
		...
		List<ChessPiece> opponentPieces = piecesOnTheBoard.stream().filter(p -> p.getColor() == opponent(color))
